...
class AsyncMQTTClient:
    ...
    def _on_connect(self, client, _flags, _rc, _properties) -> None:
    ...
    def _on_message(self, _client, topic, payload, _qos, _properties) -> None:
    ...
    def _on_disconnect(self, _client, _packet, exc=None) -> None:
